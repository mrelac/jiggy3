...
class Piece2Lv extends StatefulWidget {
  ...
  @override
  Piece2LvState createState() {
    return new Piece2LvState();
  }
}

class Piece2LvState extends State<Piece2Lv> {
  // double top;
  // double left;
  ...
  Widget build(BuildContext context) {
    ...
    return Draggable<Piece2Lv>(
      child: _clippedPath(),
      feedback: _clippedPath(),
      childWhenDragging: Container(),
      data: widget,
      onDraggableCanceled: (velocity, offset) {
        print('Piece2Lv.build(): Drag was canceled. offset = $offset');
      },
    );
